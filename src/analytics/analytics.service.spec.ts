  ...
  describe('Service configuré', () => {
    ...
    describe('getOverview', () => {
      ...
      it('devrait utiliser le cache si disponible', async () => {
        const cachedData = { period: { startDate: '2024-01-01', endDate: '2024-01-31' }, previousPeriod: { startDate: '2023-12-01', endDate: '2023-12-31' }, metrics: {} };
      ...
      it('devrait calculer correctement le pourcentage de changement', async () => {
        mockRunReport.mockResolvedValue([
          {
            rows: [
              { metricValues: [{ value: '1100' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }] },
              { metricValues: [{ value: '1000' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }] },
            ],
          },
        ]);
        service = await createService();
      ...
      it('devrait gérer le cas où previous = 0', async () => {
        mockRunReport.mockResolvedValue([
          {
            rows: [
              { metricValues: [{ value: '500' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }] },
              { metricValues: [{ value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }, { value: '0' }] },
            ],
          },
        ]);
        service = await createService();
        ...
        rows: [
          {
            ...
            metricValues: [{ value: '5000' }, { value: '3000' }, { value: '90.0' }, { value: '0.30' }],
          },
          {
            dimensionValues: [{ value: '/structure/equipes' }, { value: 'Équipes - Team Divergentes' }],
            metricValues: [{ value: '2000' }, { value: '1500' }, { value: '75.0' }, { value: '0.40' }],
          },
        ],
      };
    ...
    describe('Gestion du cache', () => {
      it('chaque endpoint doit avoir une clé de cache unique par période', async () => {
        ...
        const setCalls = mockCacheManager.set.mock.calls.map((c) => c[0] as string);
